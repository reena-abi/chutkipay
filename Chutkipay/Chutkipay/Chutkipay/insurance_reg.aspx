<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeFile="insurance_reg.aspx.cs" Inherits="insurance_reg" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <div id="msform"> 
    ...
    <fieldset>
	  ...
	  <div class="form-row"> 
        <div class="form-group col-md-6">  
          <input type="tel" id="SMS" class="form-control" placeholder="+880"> 
        </div>  
        <div class="form-group col-md-6"> 
          <input type="text" class="form-control" placeholder="+8801123456789">
        </div> 
